...
def test_all_case(net, image_list, num_classes, patch_size=(96, 96, 96), stride_xy=16, stride_z=16, save_result=True, test_save_path=None, preproc_fn=None, metric_detail=False, nms=False):
    total_metric = 0.0
    ...
    for image_path in loader:
        ...
        if metric_detail:
            print('%02d,\t%.5f, %.5f, %.5f, %.5f' % (
                int(id[2:4]), single_metric[0], single_metric[1], single_metric[2], single_metric[3]))
